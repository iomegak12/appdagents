****************************************************************************
   ...
   Please consult the documentation online for up-to-date information
       ...
       https://docs.appdynamics.com/display/4.5.2/Server+Monitoring
...
To enable HTTPS between the agent and the controller, consult the online documentation
        ...
        https://docs.appdynamics.com/display/4.5.2/Enable+SSL+for+Standalone+Machine+Agent
...
More issues are discussed online here:
        ...
        https://docs.appdynamics.com/display/4.5.2/Standalone+Machine+Agent+FAQ
